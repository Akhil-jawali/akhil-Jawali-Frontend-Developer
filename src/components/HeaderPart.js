      ...
      <div className="flex items-center gap-x-7">
        <div className="md:flex hidden items-center gap-x-7">
          <div className="flex items-center gap-x-2 hover:text-orange-500 text-lg font-medium">
            ...
            <p className="text-grey-300 ">Offers</p>
          </div>
          <div className="flex items-center gap-x-2 hover:text-orange-500 text-lg">
            <i class="fa-regular fa-circle-question"></i>
            <p className="text-grey-300">Help</p>
          </div>
          <div className="flex items-center gap-x-2 hover:text-orange-500 text-lg">
            <i class="fa-regular fa-user"></i>
            <p className="text-grey-300">Log In</p>
          </div>
        </div>
        <div className="border bg-white px-3 py-1 flex items-center rounded-full shadow">
          <input
            type="text"
            placeholder="Search"
